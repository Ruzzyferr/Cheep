...
CATEGORY_TO_SUBCATEGORY: Dict[str, str] = {
    ...
    'Aktif Yaşam Ürünleri': 'Diğer',
    'Alkolsüz Malt İçecek': 'Malt İçeceği',
    'Allık': 'Allık',
    'Amarant': 'Amarant',
    ...
    'Bisiklet ve Aksesuarları': 'Diğer',
    ...
    'Cep Telefonu Aksesuarları': 'Diğer',
    'Ceviz': 'Diğer',
    'Chia': 'Chia',
    'Cımbız': 'Diğer',
    'Dana': 'Diğer',
    ...
    'Jel Çamaşır Suyu': 'Çamaşır Deterjanı',
    'Jumbo': 'Diğer',
    'Kablolar': 'Kablolar',
    ...
    'Kalemtıraş, Silgi, Düzeltici': 'Kırtasiye',
    'Kamera': 'Foto & Kamera',
    'Kamping': 'Kamping',
    'Kanola Yağı': 'Yağ',
    ...
    'Kuzu Eti': 'Diğer',
    'Kuzu Füme': 'Diğer',
    'Kuş Aksesuarları': 'Diğer',
    'Kuş Yemi': 'Diğer',
    'Köftelik Bulgur': 'Bulgur',
    'Köpek Aksesuarları': 'Diğer',
    ...
    'Nohut': 'Diğer',
    'Nohut Cipsi': 'Cips',
    'Oda Kokusu': 'Otomatik Oda Kokuları',
    'Oda Kokusu ve Koku Gidericiler': 'Otomatik Oda Kokuları',
    'Oje': 'Oje',
    ...
    'Saç Spreyi': 'Diğer',
    'Sağlık Ürünleri': 'Diğer',
    'Sert Meyveler': 'Meyve',
    'Set Boya': 'Diğer',
    'Seyahat Aksesuarları': 'Diğer',
    ...
    'Su': 'Su',
    'Su Isıtıcı-Kettle': 'Diğer',
    'Sucuk': 'Sucuk',
    'Suluk ve Matara': 'Diğer',
    'Süpürge': 'Diğer',
    'Süt Tozu': 'Süt',
    ...
    'Temizlik Havlusu': 'Temizlik Malzemeleri',
    'Temizlik Seti': 'Diğer',
    'Tereyağ': 'Yağ',
    'Tereyağı': 'Tereyağı',
    'Terlik': 'Terlik',
    ...
    'Toka': 'Diğer',
    'Ton Balığı': 'Deniz Ürünleri',
    'Tonik': 'Diğer',
    'Tonik Suyu': 'Gazlı İçecek',
    'Tost Makinesi': 'Diğer',
    'Toz Deterjan': 'Diğer',
    ...
    'Yüzey Temizlik Havlusu': 'Temizlik Malzemeleri',
    ...
    'Çamaşır Suyu': 'Çamaşır Deterjanı',
    ...
    'Şalgam Suyu': 'Su',
    'Şampuan': 'Şampuan',
    'Şarj Aleti ve Şarj Kablosu': 'Diğer',
...
def normalize_category_name(raw_category: str, product_name: str = "") -> str:
    ...
    # NOT: Burada modül-global CATEGORY_TO_SUBCATEGORY'yi MUTATE ETME — thread-safe
    # değil ve eşleştirme product_name'e de bağlı olduğundan raw_category bazlı
    # global cache yanlış olur. Gerekirse thread-safe bir memo kullan.

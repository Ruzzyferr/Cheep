...
_RULES: List[Tuple[str, List[str]]] = [
    ...
    ("Kahvaltılık Gevrek", ["gevrek", "gevregi", "musli", "granola", "mosli",
                            "misir gevregi", "corn flakes", "cornflakes", "mısır gevreği"]),
    ("Helva", ["helva"]),
    ...
    ("Yeşillik", ["maydanoz", "roka", "dereotu", "nane", "yesillik", "semizotu",
                  "salata", "kivircik", "lahana", "tere", "feslegen", "pazi",
    ...
    ("Cips", ["cips", "patates cipsi", "doritos", "ruffles", "cheetos", "lays",
              "patos", "cipso", "tortilla", "patlamis misir", "popcorn", "cin misir",
              "misir cerezi"]),
    ...
    ("Şekerleme", ["sekerleme", "jelibon", "lokum", "marshmallow", "akide",
                   "pastil", "pestil", "meyve pestili", "meyve topu", "bonbon"]),
    ("Sakız", ["sakiz", "sakizi"]),
    # Sağlık & Takviye — supplements/vitamins (strong: beat produce flavour words)
    ...
    ("Spor Gıdası", ["protein tozu", "whey", "spor gidasi", "spor gıdası",
                     "proteinli bar", "protein bar", "creatine", "kreatin",
                     "aminoasit", "bcaa", "gainer"]),
    # İçecek
    ...
    ("Çay", ["cay", "poset cay", "demlik cay", "yesil cay", "bitki cayi",
             "meyve cayi", "karisik meyve cayi", "teekanne"]),
    ...
    ("Bebek Bakım", ["bebek sampuani", "bebek kremi", "pisik kremi", "bebek islak",
                     "biberon", "emzik", "bebek bardagi", "mama kasigi"]),
    # Pet
    ...
    ("Cam & Sofra", ["bardak", "tabak", "kase", "tencere", "tava", "paşabahçe",
                     ...
                     "kupa", "fincan", "kupa bardak"]),
    ("Mum & Dekor", ["mum", "cerceve", "çerçeve", "biblo", "vazo", "süs", "sus",
                     "yetistirme seti", "tohum", "fide", "saksi", "saksı",
                     "cicek tohumu", "sulama tabancasi", "bahce sulama",
                     "cicek sogani", "testere", "torpu", "el aleti"]),
    # Pet bakım (mama dışı)
    ("Pet Bakım", ["kedi kumu", "kopek tasma", "pet sampuan", "kemik", "kus yemi",
                   "akvaryum", "tasma", "evcil hayvan", "evcil", "egitim pedi",
                   "kedi oyuncak", "pet oyuncak", "cigneme kemigi", "pets",
                   "oyuncagi", "evcil hayvan oyuncagi"]),
    ...
    ("Elektronik", ["telefon", "kulaklik", "kulaklık", "powerbank", "sarj aleti",
                    ...
                    "ventilator", "el feneri", "su pompasi", "pompa",
                    "damacana pompasi", "sarjli pompa"]),

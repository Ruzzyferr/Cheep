...
export const COVERAGE = {
  ...
  // Üçü de ilk şube ithalatından geldi (2026-08-29, üretim veritabanı sayımı;
  // üç ülkede de 0 başarısız kayıt). Sayı 0 iken arayüz onu HİÇ göstermiyor —
  // "0 şube" yazmak, hiç yazmamaktan kötü: kullanıcıya o ülkede market
  // yokmuş izlenimi veriyor, oysa fiyatlar akıyor.
  HR: { branches: 1135, live: true },
  HU: { branches: 878, live: true },
  RO: { branches: 1920, live: true },
